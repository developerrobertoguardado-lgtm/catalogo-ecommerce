...
2. Lee los 4 archivos de esa carpeta (`change.md`, `impact.md`, `task.md`,
   ...
   - ¿Todos los criterios de aceptación de `change.md`/`validation.md` están
     implementados?
   - ¿Las rutas coinciden con lo documentado en `impact.md` y en
     `04-api-contracts.md`?
   ...
   - ¿Existen los tests planeados en `validation.md` (Pest, ver
     `05-testing-strategy.md`)?
3. Reporta un checklist con ✅/⚠️/❌ por cada criterio.
4. Si hay discrepancias, pregunta si:
   - actualizar la spec (los archivos de la carpeta) para reflejar el código
     real, o
